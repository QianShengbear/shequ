...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o($options.clickIcon, "7b"),
    d: common_vendor.p({
      size: _ctx.searchIconSize,
      name: _ctx.searchIcon,
      color: _ctx.searchIconColor ? _ctx.searchIconColor : _ctx.color
    }),
    e: common_vendor.o((...args) => $options.blur && $options.blur(...args), "44"),
    f: $data.keyword,
    g: common_vendor.o((...args) => $options.search && $options.search(...args), "67"),
    h: common_vendor.o((...args) => $options.inputChange && $options.inputChange(...args), "c3"),
    i: _ctx.disabled,
    j: common_vendor.o((...args) => $options.getFocus && $options.getFocus(...args), "db"),
    k: _ctx.focus,
    l: _ctx.maxlength,
    ...
    v: common_vendor.o((...args) => $options.clear && $options.clear(...args), "e0")
  } : {}, {
    w: _ctx.bgColor,
    ...
    C: common_vendor.o((...args) => $options.custom && $options.custom(...args), "6a"),
    D: common_vendor.n(_ctx.iconPosition === "right" && "u-search__reverse"),
    E: common_vendor.o((...args) => $options.clickHandler && $options.clickHandler(...args), "1e"),
    F: common_vendor.s({
      margin: _ctx.margin
    }),
